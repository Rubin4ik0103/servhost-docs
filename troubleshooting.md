...
| Duplicate IP | Проверьте, что адрес не назначен дважды в конфигурации или на другом интерфейсе; `ip neigh` и сообщения системы. Не используйте конфликтующий адрес до выяснения. |
